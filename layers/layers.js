...
var features_geologia3 = format_geologia3.readFeatures(json_geologia3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
...
var features_pliegues_fallas_fracturas4 = format_pliegues_fallas_fracturas4.readFeatures(json_pliegues_fallas_fracturas4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_pliegues_fallas_fracturas4 = new ol.source.Vector({
    attributions: [new ol.Attribution({html: '<a href=""></a>'})],
});
jsonSource_pliegues_fallas_fracturas4.addFeatures(features_pliegues_fallas_fracturas4);var lyr_pliegues_fallas_fracturas4 = new ol.layer.Vector({
...
var features_poligono_Cubitos5 = format_poligono_Cubitos5.readFeatures(json_poligono_Cubitos5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
...
var features_poligono_El_Hiloche_46 = format_poligono_El_Hiloche_46.readFeatures(json_poligono_El_Hiloche_46, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
...
var features_poligono_El_Hiloche_37 = format_poligono_El_Hiloche_37.readFeatures(json_poligono_El_Hiloche_37, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
...
var features_poligono_El_Hiloche_28 = format_poligono_El_Hiloche_28.readFeatures(json_poligono_El_Hiloche_28, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
...
var features_poligono_El_Hiloche_19 = format_poligono_El_Hiloche_19.readFeatures(json_poligono_El_Hiloche_19, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
...
var features_geositios10 = format_geositios10.readFeatures(json_geositios10, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
...
var features_cabeceras_municipales11 = format_cabeceras_municipales11.readFeatures(json_cabeceras_municipales11, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
...
var features_poligono_geoparque12 = format_poligono_geoparque12.readFeatures(json_poligono_geoparque12, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
...
var features_poligono_RBios13 = format_poligono_RBios13.readFeatures(json_poligono_RBios13, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
...
var features_rios14 = format_rios14.readFeatures(json_rios14, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
...
var features_datos_relieve15 = format_datos_relieve15.readFeatures(json_datos_relieve15, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
...
var features_carreteras_y_caminos_principales16 = format_carreteras_y_caminos_principales16.readFeatures(json_carreteras_y_caminos_principales16, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_carreteras_y_caminos_principales16 = new ol.source.Vector({
    attributions: [new ol.Attribution({html: '<a href=""></a>'})],
});
jsonSource_carreteras_y_caminos_principales16.addFeatures(features_carreteras_y_caminos_principales16);var lyr_carreteras_y_caminos_principales16 = new ol.layer.Vector({
...
var features_ruta_humboldt17 = format_ruta_humboldt17.readFeatures(json_ruta_humboldt17, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
...
var features_ruta_historico_minera18 = format_ruta_historico_minera18.readFeatures(json_ruta_historico_minera18, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
...
var features_ruta_geonatural19 = format_ruta_geonatural19.readFeatures(json_ruta_geonatural19, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
...
var features_ruta_geocultural20 = format_ruta_geocultural20.readFeatures(json_ruta_geocultural20, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
...
var features_minas21 = format_minas21.readFeatures(json_minas21, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
...
var features_toponimia22 = format_toponimia22.readFeatures(json_toponimia22, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
...
var features_poligono_parque_nacional_El_Chico23 = format_poligono_parque_nacional_El_Chico23.readFeatures(json_poligono_parque_nacional_El_Chico23, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_poligono_parque_nacional_El_Chico23 = new ol.source.Vector({
    attributions: [new ol.Attribution({html: '<a href=""></a>'})],
});
jsonSource_poligono_parque_nacional_El_Chico23.addFeatures(features_poligono_parque_nacional_El_Chico23);var lyr_poligono_parque_nacional_El_Chico23 = new ol.layer.Vector({
...
lyr_dem_geoparquesombreado0.setVisible(true);lyr_dem_geoparqueelevacin1.setVisible(true);lyr_municipios2.setVisible(true);lyr_geologia3.setVisible(true);lyr_pliegues_fallas_fracturas4.setVisible(true);lyr_poligono_Cubitos5.setVisible(true);lyr_poligono_El_Hiloche_46.setVisible(true);lyr_poligono_El_Hiloche_37.setVisible(true);lyr_poligono_El_Hiloche_28.setVisible(true);lyr_poligono_El_Hiloche_19.setVisible(true);lyr_geositios10.setVisible(true);lyr_cabeceras_municipales11.setVisible(true);lyr_poligono_geoparque12.setVisible(true);lyr_poligono_RBios13.setVisible(true);lyr_rios14.setVisible(true);lyr_datos_relieve15.setVisible(true);lyr_carreteras_y_caminos_principales16.setVisible(true);lyr_ruta_humboldt17.setVisible(true);lyr_ruta_historico_minera18.setVisible(true);lyr_ruta_geonatural19.setVisible(true);lyr_ruta_geocultural20.setVisible(true);lyr_minas21.setVisible(true);lyr_toponimia22.setVisible(true);lyr_poligono_parque_nacional_El_Chico23.setVisible(true);
